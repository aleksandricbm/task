...
function edit_project(th)
{
	...
	var edl='<div class="input-group" id=edprj'+th+'> <input class="form-control" value="'+$("#pr"+th).text()+'"><div class="input-group-btn"> <button type="button" class="btn btn-success">save</button> </div> </div>';
	$("#pr"+th).html(edl);
}
;
(function() {
